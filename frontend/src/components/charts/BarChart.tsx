  ...
  if (groupKey && groupKey !== yKey && groupKey !== xKey) {
    ...
    return (
      <ResponsiveContainer width="100%" height={400}>
        <BarChart data={pivotedData} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
          ...
          <XAxis
            ...
            height={80}
            tick={{ fontSize: 12 }}
            label={config.xLabel ? { value: config.xLabel, position: "bottom", offset: 40 } : undefined}
          />
          <YAxis
            tick={{ fontSize: 12 }}
